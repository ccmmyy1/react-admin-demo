...
const UploadDemo1 = LoadableComponent(() => import('../../routes/Entry/UploadDemo/UploadDemo'))

//显示组件Demo
// const CarouselDemo = LoadableComponent(() => import('../../routes/Display/CarouselDemo/index'))
const CarouselDemo = LoadableComponent(() => import('../../routes/Display/CarouselDemo/CarouselDemo'))
...
const TableDemo1 = LoadableComponent(() => import('../../routes/Display/TableDemo/TableDemo'))
    ...
    return (
      <div style={{ padding: 16, position: 'relative' }}>
        <Switch>
          ...
          <PrivateRoute exact path='/home/entry/uploademo' component={UploadDemo1} />
          ...
          <PrivateRoute exact path='/home/display/table1' component={TableDemo1} />
